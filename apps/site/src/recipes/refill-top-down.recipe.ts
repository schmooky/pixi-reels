...
// TOP-DOWN ROW REFILL — within each reel, the top row arrives first
// and the bottom row arrives last (rowOrder: 'topToBottom'). All reels
// drop simultaneously. Reads as "new symbols pour from above" — the
// natural drop-in metaphor.
