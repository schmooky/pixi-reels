...
const LEAD_IN_MS = 700;   // 42 frames
...
const reelSet = new ReelSetBuilder()
  ...
  .tumble({
    fall:   { duration: 267, ease: 'power2.in', rowStagger: 50 },  // 16f, 3f stagger
    dropIn: { duration: 400, ease: 'power2.in', rowStagger: 0, distance: 'perHole' },  // 24f
  })
