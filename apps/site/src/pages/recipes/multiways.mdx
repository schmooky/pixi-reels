...
title: MultiWays
description: Per-spin row variation. Each reel lands on a different row count between minRows and maxRows. The reel pixel height stays fixed; cell heights are derived per spin. Total ways = product of per-reel rows.
tags: [multiways, shape, geometry, reshape, variable-rows]
steps:
...
realGameVideo:
  ...
  caption: "The Dog House (Pragmatic Play)"
---
