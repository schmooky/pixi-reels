...
description: Place N-1 scatters, add anticipation on the reel that "almost" landed one. Stops short of a scatter trigger while the slow reel decelerates.
...
steps:
  ...
  - Let the slow reel decelerate on the last column
apis:
...
import code from '../../recipes/near-miss.recipe.ts?raw';
