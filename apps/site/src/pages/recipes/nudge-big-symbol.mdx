...
The classic UK fruit-machine beat: a tall wild lands with most of it
hidden in bufferAbove. only the bottom cell ("the tail") shows at the
top of the visible window. The player nudges to drag the whole block
into view.
