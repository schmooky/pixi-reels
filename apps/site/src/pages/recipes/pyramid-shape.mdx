...
## Mutually exclusive with Megaways

A static pyramid is set once at build. **Megaways** changes the row count *per spin* — different mechanic, different builder method. See the [Megaways recipe](/recipes/megaways/).

## Related

- [Megaways](/recipes/megaways/) — shape that changes per spin
