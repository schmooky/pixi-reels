...
description: The Hold & Win lifecycle end to end — the mental model, the state machine, the events, and how to wire the board to your game client.
---
...
| `board.cellCenter(cell)` / `cellBounds(cell)` | exact pixel geometry for flights & trails |
