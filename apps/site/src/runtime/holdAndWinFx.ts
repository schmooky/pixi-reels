...
// Type-only on purpose: this kit never constructs a Spine, it only drives
// ones the caller hands it. Types are erased, so importing the kit does not
// pull the spine runtime in behind it.
