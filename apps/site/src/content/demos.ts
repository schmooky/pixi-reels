...
export const DEMOS: DemoMeta[] = [
  ...
  },
  {
    ...
    summary: 'visibleCellsPerReel + center anchor builds a diamond. Cascade refills use reelSet.refill({ winners, grid }) - survivors stay put, only the cleared slots refill from above.',
