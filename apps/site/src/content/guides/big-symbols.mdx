...
- `"big symbol 'tallBar' (1x3) at (reel=0, cell=3) extends past the end of the strip on reel 0 (anchor cell + cells = 6 > visibleCells + bufferEnd = 4)."`
...
```ts
// 1x3 wild lands with its tail at visible cell 0; anchor + two stubs are
