...
For copy-pasteable code see the [recipes](/recipes/). For the verbs themselves see the [ReelSet reference](/docs/api-reelset/).
...
2. **Want to decorate new symbols after they land (multiplier badges)?** Subscribe to `cascade:place:end`. Use `isInitial` / `winnerCells` in the payload to skip survivors.
