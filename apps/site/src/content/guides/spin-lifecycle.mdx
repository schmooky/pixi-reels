...
`spin:complete` -- fires right after, same result plus total duration. This
...
`skip()` -- "player tapped slam". Round-aware. The first press also boosts
...
Drive the button's look from it.
