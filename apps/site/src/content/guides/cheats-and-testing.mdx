...
The standalone demo apps left this repo in 2.0 and live in a separate one.
The live, replayable mechanics are the [recipes](/recipes/) on this site.
each page runs the exact source it shows, so you can read the wiring and
watch it land.
