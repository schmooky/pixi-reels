...
| `skipStage` | `readonly 0 \| 1 \| 2` | `0` until the first `skipSpin()` press of the round, `2` after. `1` means a press landed the reels around a protected tease and left the tease running. the button should stay live, because the next press ends it. Drive UI labels from this. |
