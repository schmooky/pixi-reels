...
`setAnticipation` slows a reel so the player feels the tension. On its own, the slow reel shows whatever random symbols wrap onto the strip. sometimes the high-value lands, sometimes it doesn't.
