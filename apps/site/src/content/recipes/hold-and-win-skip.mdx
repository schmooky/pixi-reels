...
group: tension
oneLiner: board.skip() slams every in-flight cell to its landed position and
  fires feature:skip; the game layer cuts its flights / collect short.
  feature:end stays the single "feature over" signal.
description: board.skip() slams every in-flight cell to its landed position and
  fires feature:skip; the game layer cuts its own flights and collect short.
  feature:end stays the single "feature over" signal.
order: 42
steps:
