...
group: features
oneLiner: A collector lands and each coin's value flies into it on a bezier arc
  trailed by a stream of neon particles, ticking the total up. The board hands
  out geometry; the flight is yours.
description: A collector lands and each coin's value flies into it on a bezier
  arc trailed by a stream of neon particles, ticking the collector total up.
  Pure game-layer choreography over the board's cellCenter() and release().
order: 29
steps:
