...
- [Cascade destroys. fade, explode, present](/recipes/cascade-destroy-and-present/). the destroy stage three ways, including `WinPresenter`-driven fades
