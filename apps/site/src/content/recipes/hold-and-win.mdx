...
<a id="hold-and-win-hurry"></a>

## Hold & Win: hurry the wave

board.hurry() lands every in-flight cell through its stop instead of placing it: the board's stagger lives in each cell's spin floor, so the whole wave lands together, and each cell still spins its symbol in and bounces. `{ speed: 'turbo' }` lands the wave on the turbo profile. `feature:hurry` reports the count; the landing flow is unchanged.

<RecipeDemo code="hold-and-win-hurry" height={320} />
...
<a id="hold-and-win-clover-cell-order"></a>
...
<RecipeDemo code="hold-and-win-clover-cell-order" height={400} />

<a id="hold-and-win-clover-lift"></a>
...
<RecipeDemo code="hold-and-win-clover-lift" height={400} />

<a id="hold-and-win-clover-lift-dim"></a>
...
<RecipeDemo code="hold-and-win-clover-lift-dim" height={400} />

<a id="hold-and-win-clover-dim-symbols"></a>
...
<RecipeDemo code="hold-and-win-clover-dim-symbols" height={400} />

<a id="hold-and-win-clover-dim-one-cell"></a>
...
<RecipeDemo code="hold-and-win-clover-dim-one-cell" height={400} />
...
<a id="hold-and-win-clover-lock-rule"></a>
...
<RecipeDemo code="hold-and-win-clover-lock-rule" height={400} />
