...
group: rendering
oneLiner: Symbol classes, a card that shows its reel's phase, three-tier layering (zIndex, unmask, promote), multi-skin Spine tiers, and static-spin motion blur.
order: 70
tags:
  - symbols
  - reveal
...
<a id="layering-graded-zindex"></a>

<RecipeDemo code="layering-graded-zindex" height={420} />
...
<a id="clover-promote-win-line"></a>
...
<RecipeDemo code="clover-promote-win-line" height={400} />

<a id="landing-signal"></a>
...
<RecipeDemo code="landing-signal" />
...
<a id="spine-landing-rule"></a>

<RecipeDemo code="spine-landing-rule" height={460} />
