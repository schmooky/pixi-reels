...
group: features
oneLiner: A held coin climbs the value ladder (5 → 10 → 25 → 50 → 100) with a
  flip-and-pop — no respin, no cell movement. The new tier lives in coin.data.
description: A held coin climbs the value ladder (5 → 10 → 25 → 50 → 100) with a
  flip-and-pop flourish — no respin, no cell movement. The new tier lives in
  coin.data; the label is just repainted.
order: 33
steps:
