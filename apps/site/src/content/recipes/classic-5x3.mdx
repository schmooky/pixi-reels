...
description: Copy-paste starting point for a left-to-right line-pay slot. the
  foundation of 95% of slot games.
order: 16
steps:
...
A working starter for a classic lines slot. Drop this into a Vite + PixiJS app, wire up `loadTextures()`, and you have a live reel set with spotlight-animated line wins.
