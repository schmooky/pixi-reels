...
group: wins
oneLiner: Core never draws lines. Subscribe to win:group + getCellBounds and
  render any overlay.
description: The presenter never draws lines. Subscribe to win:group and use
  reelSet.getCellBounds to render any overlay.
order: 51
steps:
