...
title: "Skip & slam"
group: mechanics
oneLiner: Every skip lever end to end - partial slams both spellings, all three tease-protect modes, your own release plan, a press that lands instead of cutting, queued presses, skipStage, per-reel spin floors, and all four ways to own a phase.
order: 57
tags:
  - skip
  - slam
